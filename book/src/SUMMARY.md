...
- [Custom targets](platforms/custom-targets.md)

# Path finding
- [Dotfiles paths](path-finding/dotfiles.md)
- [Path from environment variable](path-finding/env.md)
- [Path from root](path-finding/root.md)
- [Debugging](path-finding/debug.md)
